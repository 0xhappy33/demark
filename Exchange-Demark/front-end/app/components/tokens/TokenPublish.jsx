...
let TokenPublish = injectIntl(
  React.createClass({
    ...
    handleValidation: function (e) {
      e.preventDefault()
      if (this.validate(e, true)) this.openModal()
    },
              ...
              <div className="row">
                  ...
                  <div className="row header-form-request panel panel-heading">
                    <div className="col-sm-12">
                      <h4 className="panel-title">
                        Demark : Publish token that you want to ICO
                      </h4>
                    </div>
                  </div>
                  <div className="panel-body">
                    <div className="row">
                      ...
                      <div className="col-sm-4">
                        <input
                          ...
                          value={this.state.nameOfTokenICO}
                        />{' '}
                        <br /> <br />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <p>
                          <b>
                            Note: You have to pay fee for publishing your token
                            2ETH for each action
                          </b>
                        </p>
                      </div>
                    </div>
                ...
                <div className="col-sm-4">
                  ...
                  <div className="panel-body">
                    ...
                    <b>Step 2: Publish it</b> <p />
                    <b>Step 3: Waiting for verify</b>
                    <p>
                      We will let you know when it is deployed to Blockchain.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-4">
                        <input
                          ...
                          onChange={e => this.handleChange(e)}
                          className="form-request-input"
                          value={this.state.startPreOrderTime}
                        />{' '}
                        <br /> <br />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-4">
                        <button
                          type="submit"
                          className="button-request"
                          onClick={this.onSubmitContractICODeploy}
                        >
                          Deploy contract ICO
                        </button>
                      </div>
